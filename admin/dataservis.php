...
if($_SESSION['level']!= 1){
echo"<script>
  alert('Anda harus masuk sebagai operator servis');
  document.location.href = 'login.php';
  </script>";
exit;
}
...
?>
    ...
    <hr>
    <a href="tambahservis.php" class="btn btn-primary mb-3"><i class="fas fa-plus-circle"></i>Tambah servis</a>
    <table class="table table-bordered table-striped table-hover">
        ...
        <tr>
            ...
            <a href="ubahservis.php?idservice=<?=$servis['idservice'];?>" class="btn btn-warning">Edit</a>
            <a href="hapusservis.php?idservice=<?=$servis['idservice'];?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus servis ini?')">Hapus</a>
</td>
